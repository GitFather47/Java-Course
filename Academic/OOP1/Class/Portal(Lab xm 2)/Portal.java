...
public class Portal2 {
    public static void main(String[] args) {
        ...
        int size, indexOfMaxAvg = 0, indexOfSecondMaxAvg = -1;
        int maxAvgDraft = 0;
        ...
        for (int i = 0; i < stds.length; i++) {
            if (stds[i] != null && stds[i].getAvg() == maxAvgDraft && i != indexOfMaxAvg) {
                indexOfSecondMaxAvg = i;
                break;
            }
        }
        ...
        if (indexOfSecondMaxAvg != -1) {
            System.out.println("Another student with the same highest average score:");

            System.out.println("Name: " + stds[indexOfSecondMaxAvg].getName());
            System.out.println("Average Score: " + stds[indexOfSecondMaxAvg].getAvg());
        }
    }
}
class Student {
