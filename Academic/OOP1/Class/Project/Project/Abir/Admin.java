...
public class Admin extends JFrame implements MouseListener,ItemListener,ActionListener
{
	...
	public Admin()
	{
		...
		bg.setBackground(new Color(128, 175, 175));*/
		/*imgl = new ImageIcon("MAA3.jpg");
	    JLabel imgLl = new JLabel(imgl);
		imgLl.setBounds(00, 300, 50, 50);
		bg.add(imgLl);*/
		
		
		pr = new JButton("Profile");  
	    pr.setBounds(300, 250, 200,40);
